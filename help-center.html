...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/help-center.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:29 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
      ...
      <div class="container">
        <div class="row justify-center text-center">
          <div class="col-xl-6 col-lg-8 col-md-10">
            <div class="sectionTitle -md">
              <h2 class="sectionTitle__title">Welcome to the Help Center</h2>
            ...
            <div class="single-field d-flex items-center justify-end x-gap-10 y-gap-20 pt-40">
              <div class="col-12">
                <input class="border-light bg-white h-68" type="text" placeholder="Cancellation, meeting point, etc.">
              </div>

              <div class="absolute mr-4">
                <button class="button -md -dark-1 h-60 bg-blue-1 text-white">Search</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row y-gap-30 pt-60 lg:pt-40">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="bg-blue-1-05 rounded-4 px-50 py-40">
              <div class="size-70 bg-white rounded-full flex-center">
                <img src="img/pages/help/icons/2.svg" alt="icon">
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="bg-blue-1-05 rounded-4 px-50 py-40">
              <div class="size-70 bg-white rounded-full flex-center">
                <img src="img/pages/help/icons/3.svg" alt="icon">
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="bg-blue-1-05 rounded-4 px-50 py-40">
              <div class="size-70 bg-white rounded-full flex-center">
                <img src="img/pages/help/icons/4.svg" alt="icon">
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="bg-blue-1-05 rounded-4 px-50 py-40">
              <div class="size-70 bg-white rounded-full flex-center">
                <img src="img/pages/help/icons/5.svg" alt="icon">
              </div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/help-center.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:31 GMT -->
</html>
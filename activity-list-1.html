...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/activity-list-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:47 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            ...
            <div class="mainSearch -col-2 bg-white px-10 py-10 lg:px-20 lg:pt-5 lg:pb-20 rounded-4 mt-30">
              <div class="button-grid items-center">
                ...
                <div class="button-item">
                  <button class="mainSearch__submit button -dark-1 py-20 px-40 col-12 rounded-4 bg-blue-1 text-white">
                ...
                <div class="border-top-light pt-30">
                  <div class="row x-gap-20 y-gap-20">
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12" src="img/lists/activity/1/1.png" alt="image">
                    ...
                    <div class="col-md">
                      ...
                      <h3 class="text-18 lh-16 fw-500">Edinburgh Sky to Sea Bike Tour by Manual<br> or E-Bike</h3>
                          ...
                          <div class="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider">
                            <div class="swiper-wrapper">
                              ...
                              <div class="swiper-slide">
                                <img class="col-12" src="img/lists/activity/1/2.png" alt="image">
                              </div>

                              <div class="swiper-slide">
                                <img class="col-12" src="img/lists/activity/1/3.png" alt="image">
                              </div>

                              <div class="swiper-slide">
                                <img class="col-12" src="img/lists/activity/1/4.png" alt="image">
                              </div>
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12" src="img/lists/activity/1/3.png" alt="image">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12" src="img/lists/activity/1/4.png" alt="image">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12" src="img/lists/activity/1/5.png" alt="image">
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/activity-list-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:49 GMT -->
</html>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:02 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
  ...
  <main>
          ...
          <div class="col-auto">
            <div class="d-flex items-center">
              ...
              <div class="single-field relative d-flex items-center xl:d-none mr-20">
                <input class="pl-50 border-light text-dark-1 h-50 rounded-8" type="email" placeholder="Destination, attraction, hotel, etc">
    ...
    <section data-anim-wrap class="masthead -type-3 relative z-5">
      <div data-anim-child="fade delay-1" class="masthead__bg bg-dark-3">
        <img src="img/masthead/3/bg.png" alt="image">
      </div>
      ...
      <div data-anim-wrap class="container">
        ...
        <div class="row y-gap-20 pt-40">
          ...
          <div data-anim-child="slide-left delay-4" class="col-lg-4 col-sm-6">
            ...
            <div class="ctaCard -type-1 rounded-4 ">
              <div class="ctaCard__image ratio ratio-41:45">
                <img class="img-ratio js-lazy" src="#" data-src="img/backgrounds/3.png" alt="image">
              </div>
      ...
      <div class="container">
        ...
        <div class="row y-gap-40 justify-between pt-50">
          ...
          <div class="col-lg-3 col-sm-6">
            ...
            <div class="featureIcon -type-1 ">
              <div class="d-flex justify-center">
                <img src="#" data-src="img/featureIcons/3/1.svg" alt="image" class="js-lazy">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            ...
            <div class="featureIcon -type-1 ">
              <div class="d-flex justify-center">
                <img src="#" data-src="img/featureIcons/3/2.svg" alt="image" class="js-lazy">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            ...
            <div class="featureIcon -type-1 ">
              <div class="d-flex justify-center">
                <img src="#" data-src="img/featureIcons/3/3.svg" alt="image" class="js-lazy">
              </div>
      ...
      <div data-anim-wrap class="container">
        ...
        <div class="row y-gap-40 justify-between pt-40 sm:pt-20">
          ...
          <div data-anim-child="slide-up delay-4" class="col-xl-6 col-md-4 col-sm-6">
            ...
            <a href="#" class="citiesCard -type-3 d-block rounded-4 h-full">
              <div class="citiesCard__image ">
                <img class="img-ratio js-lazy" src="#" data-src="img/destinations/2/2.png" alt="image">
              </div>
          ...
          <div data-anim-child="slide-up delay-5" class="col-xl-3 col-md-4 col-sm-6">
            ...
            <a href="#" class="citiesCard -type-3 d-block rounded-4 ">
              <div class="citiesCard__image ratio ratio-1:1">
                <img class="img-ratio js-lazy" src="#" data-src="img/destinations/2/3.png" alt="image">
              </div>
          ...
          <div data-anim-child="slide-up delay-6" class="col-xl-6 col-md-4 col-sm-6">
            ...
            <a href="#" class="citiesCard -type-3 d-block rounded-4 h-full">
              <div class="citiesCard__image ">
                <img class="img-ratio js-lazy" src="#" data-src="img/destinations/2/4.png" alt="image">
              </div>
              ...
              <div class="cruiseCard__image">
                ...
                <div class="cardImage ratio ratio-6:5">
                  <div class="cardImage__content">
                    ...
                    <img class="rounded-4 col-12" src="img/cruises/1.png" alt="image">
                  ...
                  <div class="cardImage__content">
                    ...
                    <div class="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider">
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                          <img class="col-12" src="img/cruises/2.png" alt="image">
                        </div>
              ...
              <div class="cruiseCard__image">
                ...
                <div class="cardImage ratio ratio-6:5">
                  <div class="cardImage__content">
                    ...
                    <img class="rounded-4 col-12" src="img/cruises/3.png" alt="image">
              ...
              <div class="cruiseCard__image">
                ...
                <div class="cardImage ratio ratio-6:5">
                  <div class="cardImage__content">
                    ...
                    <img class="rounded-4 col-12" src="img/cruises/4.png" alt="image">
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:10 GMT -->
</html>
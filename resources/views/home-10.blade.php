...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:27 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
          ...
          <div class="col-auto">
            <div class="d-flex items-center">
              ...
              <div class="d-none xl:d-flex x-gap-20 items-center pl-30 text-dark-1" data-x="header-mobile-icons" data-x-toggle="text-white">
                ...
                <div><button class="d-flex items-center icon-menu text-inherit text-22" data-x-click="html, header, header-logo, header-mobile-icons, mobile-menu"></button></div>
              </div>
            </div>
          </div>
...
>>>>>>> 3c46dfe8d22304afa20f1b32fd48e3ec8e9bf531
              ...
              <div data-anim-child="slide-up delay-3">
                    ...
                    <div class="dropdown js-dropdown js-economy-active">
                      ...
                      <div class="toggle-element -dropdown  js-click-dropdown js-economy-toggle">
                        <div class="text-14 y-gap-15 js-dropdown-list">
                          ...
                          <div><a href="#" class="d-block js-dropdown-link">Middle</a></div>
                    ...
                    <div class="dropdown js-dropdown js-bags-active">
                      ...
                      <div class="toggle-element -dropdown  js-click-dropdown js-bags-toggle">
                        <div class="text-14 y-gap-15 js-dropdown-list">
                          ...
                          <div><a href="#" class="d-block js-dropdown-link">4 Bags</a></div>
                ...
                <div class="mainSearch -col-4 -w-1070 bg-white shadow-1 rounded-4 pr-20 py-20 lg:px-20 lg:pt-5 lg:pb-20 mt-15">
                  <div class="button-grid items-center">
                    ...
                    <div class="searchMenu-guests px-24 lg:py-20 lg:px-0 js-form-dd js-form-counters">
                    ...
                    <div class="button-item">
                      <button class="mainSearch__submit button -blue-1 py-15 px-35 h-60 col-12 rounded-4 bg-dark-1 text-white">
    ...
    <section class="layout-pt-md layout-pb-md">
      <div data-anim-wrap class="container">
        <div data-anim-child="slide-up" class="row y-gap-20 justify-between items-end">
          <div class="col-auto">
            <div class="sectionTitle -md">
              <h2 class="sectionTitle__title">Recommended Flights</h2>
    ...
    <section class="layout-pt-md layout-pb-lg">
      <div data-anim-wrap class="container">
        <div data-anim-child="slide-up" class="row justify-between items-end">
          <div class="col-auto">
            <div class="sectionTitle -md">
        ...
        <div class="relative mt-40 sm:mt-20 js-section-slider" data-gap="30" data-slider-cols="xl-4 lg-3 md-2 sm-1">
          <div class="swiper-wrapper">
            ...
            <div data-anim-child="slide-up delay-1" class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-3 d-block rounded-4 ">
                <div class="citiesCard__image ratio ratio-1:1">
                  <img class="img-ratio js-lazy" src="#" data-src="img/destinations/4/1.png" alt="image">
                </div>
            ...
            <div data-anim-child="slide-up delay-2" class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-3 d-block rounded-4 ">
                <div class="citiesCard__image ratio ratio-1:1">
                  <img class="img-ratio js-lazy" src="#" data-src="img/destinations/4/2.png" alt="image">
                </div>
            ...
            <div data-anim-child="slide-up delay-3" class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-3 d-block rounded-4 ">
                <div class="citiesCard__image ratio ratio-1:1">
                  <img class="img-ratio js-lazy" src="#" data-src="img/destinations/4/3.png" alt="image">
                </div>
            ...
            <div data-anim-child="slide-up delay-4" class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-3 d-block rounded-4 ">
                <div class="citiesCard__image ratio ratio-1:1">
                  <img class="img-ratio js-lazy" src="#" data-src="img/destinations/4/4.png" alt="image">
                </div>
            ...
            <div data-anim-child="slide-up delay-5" class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-3 d-block rounded-4 ">
                <div class="citiesCard__image ratio ratio-1:1">
                  <img class="img-ratio js-lazy" src="#" data-src="img/destinations/4/5.png" alt="image">
                </div>
            ...
            <div data-anim-child="slide-up delay-6" class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-3 d-block rounded-4 ">
                <div class="citiesCard__image ratio ratio-1:1">
                  <img class="img-ratio js-lazy" src="#" data-src="img/destinations/4/6.png" alt="image">
                </div>
    ...
    <section class="layout-pt-lg layout-pb-lg">
      <div data-anim-wrap class="container">
        ...
        <div class="relative">
          <div class="overflow-hidden mt-40 sm:mt-20 js-section-slider" data-gap="30" data-slider-cols="xl-4 lg-3 md-2 sm-1" data-nav-prev="js-routes-slider-prev" data-nav-next="js-routes-slider-next">
            <div class="swiper-wrapper">

              <div data-anim-child="slide-up delay-1" class="swiper-slide">

                <a href="rental-single.html" class="rentalCard -type-2 ">
                  ...
                  <div class="rentalCard__content mt-10">
                    <h4 class="rentalCard__title text-dark-1 text-18 lh-16 fw-500">
                      <span>Istanbul - New York</span>
                    </h4>

                    <div class="d-flex items-center text-light-1">
                      <div class="text-14">Round-trip</div>
                      <div class="size-3 bg-light-1 rounded-full ml-10 mr-10"></div>
                      <div class="text-14">Wed, Jun 1 - Sun, Jun 5</div>
                    </div>

                    <div class="text-light-1  mt-5">
                      <span class="fw-500 text-dark-1">US$72</span>
                      / per night
                    </div>
                  </div>
                </a>
              ...
              <div data-anim-child="slide-up delay-2" class="swiper-slide">
                ...
                <a href="rental-single.html" class="rentalCard -type-2 ">
                  <div class="rentalCard__image">
                    <div class="cardImage ratio ratio-6:5">
                      <div class="cardImage__content">
                        <img class="rounded-4 col-12" src="img/rentals/2.png" alt="image">
                      </div>
                    </div>
                  </div>
    ...
    <section data-anim-wrap class="section-bg pt-80 pb-80 md:pt-40 md:pb-40">
      ...
      <div data-anim-child="fade delay-1" class="section-bg__item -w-1500 rounded-4 bg-blue-2"></div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:28 GMT -->
</html>
      ...
      <div class="col-xl-6 col-lg-7 col-md-9">
        <div class="px-50 py-50 sm:px-20 sm:py-20 bg-white shadow-4 rounded-4">
          <div class="row y-gap-20">
            <div class="col-12">
              <h1 class="text-22 fw-500">  {{ translate('view_all')}}</h1>
              <p class="mt-10">{{translate('donot_have')}} <a href="{{ translate('signup') }}" class="text-blue-1">{{translate('sign_up_for_free')}}</a></p>
            </div>
            ...
            <div class="col-12">
              <a href="#" class="text-14 fw-500 text-blue-1 underline"> {{ translate('forgot_your_password')}}</a>
            </div>

            <div class="col-12">

              <a href="#" class="button py-20 -dark-1 bg-blue-1 text-white">
              {{ translate('sign_in')}} <div class="icon-arrow-top-right ml-15"></div>
              </a>
          ...
          <div class="row y-gap-20 pt-30">
            ...
            <div class="col-12">
              <div class="text-center px-30">{{ translate('creating_an_account')}} </div>
            </div>
          </div>
        </div>
      </div>

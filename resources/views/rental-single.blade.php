...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/rental-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:00 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
...
<body>
  ...
  <main>
        ...
        <div class="row y-gap-30">
          <div class="col-12">
            <div class="row justify-between items-end">
              <div class="col-auto">
                <h1 class="text-26 fw-600">Cheval Place for 3 persons</h1>
                ...
                <div class="row x-gap-20 y-gap-20 items-center pt-10">
                  <div class="col-auto">
                    <div class="row x-gap-10 items-center">
                      ...
                      <div class="col-auto">
                        <button data-x-click="mapFilter" class="text-blue-1 text-15 underline">Show on map</data-x-click="mapFilter">
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-12">
            <div class="galleryGrid -type-1 relative">
              ...
              <div class="galleryGrid__item">
                <img src="img/lists/rental/single/1.png" alt="image" class="rounded-4">
              </div>

              <div class="galleryGrid__item">
                <img src="img/lists/rental/single/2.png" alt="image" class="rounded-4">
              </div>

              <div class="galleryGrid__item">
                <img src="img/lists/rental/single/3.png" alt="image" class="rounded-4">
              </div>

              <div class="galleryGrid__item">
                <img src="img/lists/rental/single/4.png" alt="image" class="rounded-4">
              </div>

              <div class="galleryGrid__item">
                <img src="img/lists/rental/single/5.png" alt="image" class="rounded-4">
              </div>


              <div class="absolute h-full col-12 z-2 px-20 py-20 d-flex justify-end items-end">
                <a href="img/lists/rental/single/1.png" class="button -blue-1 px-24 py-15 bg-white text-dark-1 js-gallery" data-gallery="gallery2">
                  See All 90 Photos
                </a>
                <a href="img/lists/rental/single/2.png" class="js-gallery" data-gallery="gallery2"></a>
                <a href="img/lists/rental/single/3.png" class="js-gallery" data-gallery="gallery2"></a>
                <a href="img/lists/rental/single/4.png" class="js-gallery" data-gallery="gallery2"></a>
                <a href="img/lists/rental/single/5.png" class="js-gallery" data-gallery="gallery2"></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-8">
            ...
            <div>
              ...
              <div class="row y-gap-15 pt-15">
                ...
                <div class="col-sm-5">
                  <div class="d-flex items-center">
                    <i class="icon-living-room text-20 mr-10"></i>
                ...
                <div class="col-sm-5">
                  <div class="d-flex items-center">
                    ...
                    <div class="text-15">Media &amp; Technology</div>
                  </div>
                </div>
                ...
                <div class="col-sm-5">
                  <div class="d-flex items-center">
                    ...
                    <div class="text-15">Food &amp; Drink</div>
                  </div>
                </div>
                ...
                <div class="col-sm-5">
                  <div class="d-flex items-center">
                    ...
                    <div class="text-15">Reception Services</div>
                  </div>
                </div>
                ...
                <div class="col-sm-5">
                  <div class="d-flex items-center">
                    ...
                    <div class="text-15">Cleaning Services</div>
                  </div>
                </div>

              </div>

              <a href="#" class="d-block text-14 text-blue-1 fw-500 underline mt-20">Show all 29 amenities</a>
            </div>

            <div class="border-top-light mt-40 mb-40"></div>

            <div>
              <h3 class="text-22 fw-500 mb-20">Availability</h3>

              <div class="row x-gap-60 y-gap-40 justify-center">

                <div class="col-lg-6">
                  <div class="text-18 fw-500 text-center mb-10">April 2022</div>
                  ...
                  <div class="table-calendar">
                    ...
                    <div class="table-calendar__grid">
                      ...
                      <div class="lh-1">
                        ...
                        <div class="text-purple-1 fw-500 text-12 mt-5">$929</div>
                ...
                <div class="row y-gap-15 items-center justify-between">
                  <div class="col-auto">
                    <div class="text-14 text-light-1">
                      <span class="text-20 fw-500 text-dark-1 mr-5">US$72</span> nights
                    </div>
                  </div>
    ...
    <div class="container">
      <div class="mt-40 mb-40 border-top-light"></div>
    </div>

    <section>
      <div class="container">
        <h3 class="text-22 fw-500 mb-20">Where you’ll be</h3>
        <div class="mb-20">Greater London, England, United Kingdom</div>
    ...
    <section class="pt-40 layout-pb-lg">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h3 class="text-22 fw-500">Things to know</h3>
          </div>
        </div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/rental-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:02 GMT -->
</html>
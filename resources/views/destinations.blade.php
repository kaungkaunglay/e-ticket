...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/destinations.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:17 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
    ...
    <section class="layout-pb-md">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="relative d-flex">
              <img src="img/pages/destinations/1.png" alt="image" class="col-12 rounded-4">
        ...
        <div class="row y-gap-20 pt-40">
          <div class="col-auto">
            <h2 class="">What to know before visiting London</h2>
          </div>
          ...
          <div class="col-xl-4">
            <div class="relative d-flex ml-35">
              <img src="img/pages/destinations/map.png" alt="image" class="col-12 rounded-4">
              ...
              <div class="absolute d-flex justify-center items-end col-12 h-full z-1 px-35 py-20">
                <button class="button h-50 px-25 -blue-1 bg-white text-dark-1 text-14 fw-500 col-12">
                  <i class="icon-eye text-18 mr-10"></i>
    ...
    <section class="layout-pt-md layout-pb-lg">
      <div class="container">
        <div class="row">
          <div class="col-auto">
            <div class="sectionTitle -md">
              <h2 class="sectionTitle__title">Top sights in London</h2>
              ...
              <div class="d-flex flex-wrap y-gap-30">
                <div class="col-auto">
                  <div class="ratio ratio-1:1 w-200">
                    <img src="img/backgrounds/1.png" alt="image" class="img-ratio">
                  </div>
                </div>

                <div class="col">
                  <div class="d-flex flex-column justify-center h-full px-30 py-20">
                    <h3 class="text-18 fw-500">The British Museum</h3>
                    <p class="text-15 mt-5">Learn about British history at the Tower of London, a medieval castle that was first built in 1066 by William the Conqueror.</p>
                    <a href="#" class="d-block text-14 text-blue-1 fw-500 underline mt-5">See More</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="rounded-4 border-light">
              <div class="d-flex flex-wrap y-gap-30">
                ...
                <div class="col">
                  <div class="d-flex flex-column justify-center h-full px-30 py-20">
                    <h3 class="text-18 fw-500">London Eye</h3>
                    <p class="text-15 mt-5">Learn about British history at the Tower of London, a medieval castle that was first built in 1066 by William the Conqueror.</p>
                    <a href="#" class="d-block text-14 text-blue-1 fw-500 underline mt-5">See More</a>
                  </div>
                </div>
          ...
          <div class="col-lg-6">
            <div class="rounded-4 border-light">
              <div class="d-flex flex-wrap y-gap-30">
                ...
                <div class="col">
                  <div class="d-flex flex-column justify-center h-full px-30 py-20">
                    <h3 class="text-18 fw-500">Tower of London</h3>
                    <p class="text-15 mt-5">Learn about British history at the Tower of London, a medieval castle that was first built in 1066 by William the Conqueror.</p>
                    <a href="#" class="d-block text-14 text-blue-1 fw-500 underline mt-5">See More</a>
                  </div>
                </div>
          ...
          <div class="col-lg-6">
            <div class="rounded-4 border-light">
              <div class="d-flex flex-wrap y-gap-30">
                ...
                <div class="col">
                  <div class="d-flex flex-column justify-center h-full px-30 py-20">
                    <h3 class="text-18 fw-500">Tower Bridge</h3>
                    <p class="text-15 mt-5">Learn about British history at the Tower of London, a medieval castle that was first built in 1066 by William the Conqueror.</p>
                    <a href="#" class="d-block text-14 text-blue-1 fw-500 underline mt-5">See More</a>
                  </div>
                </div>
        ...
        <div class="row justify-center mt-40">
          <div class="col-auto">
            ...
            <a href="#" class="button h-50 w-250 -outline-blue-1 text-blue-1">
              Explore more <div class="icon-arrow-top-right ml-15"></div>
            </a>
    ...
    <section class="layout-pt-md layout-pb-lg">
      <div class="container">
        <div class="row y-gap-20">
          <div class="col-auto">
            <div class="sectionTitle -md">
              <h2 class="sectionTitle__title">Destinations near London</h2>
              <p class=" sectionTitle__text mt-5 sm:mt-0">These popular destinations have a lot to offer</p>
            </div>
          </div>
        </div>
        ...
        <div class="pt-40 js-section-slider" data-gap="30" data-slider-cols="xl-6 lg-4 md-3 sm-2 base-1">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-2 ">
                <div class="citiesCard__image rounded-4 ratio ratio-1:1">
                  <img class="img-ratio rounded-4 js-lazy" data-src="img/destinations/3/1.png" src="#" alt="image">
                </div>
            ...
            <div class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-2 ">
                <div class="citiesCard__image rounded-4 ratio ratio-1:1">
                  <img class="img-ratio rounded-4 js-lazy" data-src="img/destinations/3/2.png" src="#" alt="image">
                </div>
            ...
            <div class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-2 ">
                <div class="citiesCard__image rounded-4 ratio ratio-1:1">
                  <img class="img-ratio rounded-4 js-lazy" data-src="img/destinations/3/3.png" src="#" alt="image">
                </div>
            ...
            <div class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-2 ">
                <div class="citiesCard__image rounded-4 ratio ratio-1:1">
                  <img class="img-ratio rounded-4 js-lazy" data-src="img/destinations/3/4.png" src="#" alt="image">
                </div>
            ...
            <div class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-2 ">
                <div class="citiesCard__image rounded-4 ratio ratio-1:1">
                  <img class="img-ratio rounded-4 js-lazy" data-src="img/destinations/3/5.png" src="#" alt="image">
                </div>
            ...
            <div class="swiper-slide">
              ...
              <a href="#" class="citiesCard -type-2 ">
                <div class="citiesCard__image rounded-4 ratio ratio-1:1">
                  <img class="img-ratio rounded-4 js-lazy" data-src="img/destinations/3/6.png" src="#" alt="image">
                </div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/destinations.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:18 GMT -->
</html>
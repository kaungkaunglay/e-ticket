...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/cruise-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:15 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
      ...
      <div class="halfMap__content">
          ...
          <div class="button-grid items-center">
            ...
            <div class="searchMenu-loc px-30 lg:py-20 lg:px-0 js-form-dd js-liverSearch">
              ...
              <div data-x-dd-click="searchMenu-loc">
                ...
                <div class="text-15 text-light-1 ls-2 lh-16">
                  <input autocomplete="off" type="search" placeholder="Holland America Line" class="js-search js-dd-focus" />
                </div>
              </div>
        ...
        <div class="row x-gap-10 y-gap-10 pt-20">
          <div class="col-auto">
            ...
            <div class="dropdown js-dropdown js-cabinType-active">
              <div class="dropdown__button d-flex items-center text-14 rounded-100 border-light px-15 h-34" data-el-toggle=".js-cabinType-toggle" data-el-toggle-active=".js-cabinType-active">
                <span class="js-dropdown-title">Cabin Type</span>
                <i class="icon icon-chevron-sm-down text-7 ml-10"></i>
              </div>

              <div class="toggle-element -dropdown js-click-dropdown js-cabinType-toggle">
                <div class="text-15 y-gap-15 js-dropdown-list">

                  <div><a href="#" class="d-block js-dropdown-link">Small</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">Medium</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">Large</a></div>
          ...
          <div class="col-auto">
            ...
            <div class="dropdown js-dropdown js-lenght-active">
              <div class="dropdown__button d-flex items-center text-14 rounded-100 border-light px-15 h-34" data-el-toggle=".js-lenght-toggle" data-el-toggle-active=".js-lenght-active">
                <span class="js-dropdown-title">Lenght</span>
                <i class="icon icon-chevron-sm-down text-7 ml-10"></i>
              </div>

              <div class="toggle-element -dropdown js-click-dropdown js-lenght-toggle">
                <div class="text-15 y-gap-15 js-dropdown-list">

                  <div><a href="#" class="d-block js-dropdown-link">Less than 16 feet</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">16 - 26 feet</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">26 - 40 feet</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">40 - 65 feet</a></div>
          ...
          <div class="col-auto">
            ...
            <div class="dropdown js-dropdown js-criseStyle-active">
              <div class="dropdown__button d-flex items-center text-14 rounded-100 border-light px-15 h-34" data-el-toggle=".js-criseStyle-toggle" data-el-toggle-active=".js-criseStyle-active">
                <span class="js-dropdown-title">Cruise Style</span>
                <i class="icon icon-chevron-sm-down text-7 ml-10"></i>
              </div>

              <div class="toggle-element -dropdown js-click-dropdown js-criseStyle-toggle">
                <div class="text-15 y-gap-15 js-dropdown-list">

                  <div><a href="#" class="d-block js-dropdown-link">Trawler</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">Deck boat</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">Bay boat</a></div>
          ...
          <div class="col-12">
            ...
            <div class="border-top-light pt-30">
              <div class="row x-gap-20 y-gap-20">
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12" src="img/lists/cruise/1/1.png" alt="image">
                ...
                <div class="col-md">
                  <div class="text-14 text-light-1">Norwegian Getaway</div>

                  <h3 class="text-16 lh-17 fw-500 mt-5">
                    7 Night Cruise to the Western<br> Mediterranean
                  </h3>

                  <div class="row y-gap-15 pt-20">

                    <div class="col-auto">
                      <div class="text-14">Sailing Date</div>
                      <div class="text-14 text-light-1">18/06/2022</div>
                    </div>

                    <div class="col-auto">
                      <div class="text-14">Departs</div>
                      <div class="text-14 text-light-1">Southampton</div>
                    </div>

                    <div class="col-auto">
                      <div class="text-14">Ports (7)</div>
                ...
                <div class="col-md-auto text-right md:text-left">
                  <div class="row x-gap-10 y-gap-10 justify-end items-center md:justify-start">
                    ...
                    <div class="col-auto">
                      <div class="text-14 lh-13 text-light-1">
                        <span class="text-15 fw-500 text-dark-1">4.82</span> 94 reviews
                      </div>
                    </div>
                  </div>

                  <div class="text-22 lh-12 fw-600 mt-50 md:mt-32 sm:mt-20">US$72</div>
                  <div class="text-14 text-light-1 mt-5">per adult</div>


                  <a href="#" class="button px-24 py-10 -dark-1 bg-blue-1 text-white mt-15">
                      ...
                      <div class="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider">
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            <img class="col-12" src="img/lists/cruise/1/2.png" alt="image">
                          </div>

                          <div class="swiper-slide">
                            <img class="col-12" src="img/lists/cruise/1/3.png" alt="image">
                          </div>

                          <div class="swiper-slide">
                            <img class="col-12" src="img/lists/cruise/1/4.png" alt="image">
                          </div>
                ...
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12" src="img/lists/cruise/1/3.png" alt="image">

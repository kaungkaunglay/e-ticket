...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/cruise-list-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:11 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
        ...
        <div class="row">
          <div class="col-12">
            <div class="text-center">
              <h1 class="text-30 fw-600">Europe Cruises</h1>
            </div>
          ...
          <div class="col-xl-3 col-lg-4 lg:d-none">
            <aside class="sidebar y-gap-40">
              <div class="sidebar__item -no-border">
                <h5 class="text-18 fw-500 mb-10">Cabin type</h5>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Inside</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Outside</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Suite</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Balcony</div>
              ...
              <div class="sidebar__item">
                <h5 class="text-18 fw-500 mb-10">Cruise length</h5>
                <div class="sidebar-checkbox">
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">1-2 days</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">3-4 days</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">5-6 days</div>
              ...
              <div class="sidebar__item">
                <h5 class="text-18 fw-500 mb-10">Cruise Style</h5>
                <div class="sidebar-checkbox">
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Family Cruises</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Luxury Cruises</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">River Cruises</div>
              ...
              <div class="sidebar__item">
                <h5 class="text-18 fw-500 mb-10">Port</h5>
                <div class="sidebar-checkbox">
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Aalborg</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Aarhus</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Abu Dhabi</div>
                  ...
                  <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-15 ml-10">Agadir</div>
                  ...
                  <div class="row x-gap-20 y-gap-20">
                    ...
                    <div class="col-md">
                      ...
                      <h3 class="text-18 lh-16 fw-500 mt-5">
                        7 Night Cruise to the Western<br class="md:d-none"> Mediterranean
                      </h3>
                    ...
                    <div class="col-md-auto text-right md:text-left">
                      ...
                      <div class="text-14 text-light-1 mt-40">From</div>
                      <div class="text-22 lh-12 fw-600 mt-5">US$72</div>
                      <div class="text-14 text-light-1 mt-5">per adult</div>


                      <a href="#" class="button h-50 px-24 -dark-1 bg-blue-1 text-white mt-24">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12" src="img/lists/cruise/1/4.png" alt="image">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12" src="img/lists/cruise/1/5.png" alt="image">
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/cruise-list-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:13 GMT -->
</html>
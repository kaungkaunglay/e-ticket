            ...
            <div class="col-xl-9">
              <div class="masthead__content">
                <div class="text-center">
                  <h1 data-anim-child="slide-up delay-2" class="text-60 lg:text-40 md:text-30 text-white">Reserve Your Table at the Finest Restaurants Today!</h1>
      ...
      <div data-anim-child="slide-up delay-2" class="col-lg-3 col-sm-6">
        ...
        <div class="featureIcon -type-1 ">
          <div class="d-flex justify-center">
            <img src="{{asset('assets/img/hotels/2.png')}}" data-src="{{asset('assets/img/hotels/2.png')}}" alt="image" class="js-lazy">
          </div>
        ...
        <a href="#" class="blogCard -type-2 d-block bg-white rounded-4 shadow-4">
          <div class="blogCard__image">
            <div class="ratio ratio-1:1 rounded-4">
              <img class="img-ratio js-lazy" src="{{asset('assets/img/hotels/2.png')}}" data-src="{{asset('assets/img/hotels/2.png')}}" alt="image">
            </div>
          </div>

...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/activity-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:52 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
      ...
      <div class="halfMap__content">
        <div class="mainSearch bg-white pr-10 py-10 lg:px-20 lg:pt-5 lg:pb-20 bg-light-2 rounded-4">
          <div class="button-grid items-center">
            ...
            <div class="searchMenu-date px-30 lg:py-20 lg:px-0 -left js-form-dd js-calendar js-calendar-el">
            ...
            <div class="searchMenu-guests px-30 lg:py-20 lg:px-0 js-form-dd js-form-counters">
              ...
              <div data-x-dd-click="searchMenu-guests">
                <h4 class="text-15 fw-500 ls-2 lh-16">Activity Type</h4>
        ...
        <div class="row x-gap-10 y-gap-10 pt-20">
          ...
          <div class="col-auto">
            ...
            <div class="dropdown js-dropdown js-attractions-active">
              <div class="dropdown__button d-flex items-center text-14 rounded-100 border-light px-15 h-34" data-el-toggle=".js-attractions-toggle" data-el-toggle-active=".js-attractions-active">
                <span class="js-dropdown-title">Attractions</span>
                <i class="icon icon-chevron-sm-down text-7 ml-10"></i>
              </div>

              <div class="toggle-element -dropdown js-click-dropdown js-attractions-toggle">
                <div class="text-15 y-gap-15 js-dropdown-list">

                  <div><a href="#" class="d-block js-dropdown-link">V-Formation</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">Events in the Sky</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">The Fungroup</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">Rongen Aktief</a></div>
            ...
            <div class="border-top-light pt-20">
              <div class="row x-gap-20 y-gap-20">
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12" src="img/lists/activity/3/1.png" alt="image">
                ...
                <div class="col-md">
                  ...
                  <h3 class="text-16 lh-16 fw-500">Edinburgh Sky to Sea Bike Tour by Manual<br> or E-Bike</h3>
                ...
                <div class="col-md-auto text-right md:text-left">
                  ...
                  <div class="text-14 text-light-1 mt-30 md:mt-20">From</div>
                ...
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12" src="img/lists/activity/3/2.png" alt="image">
                ...
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12" src="img/lists/activity/3/3.png" alt="image">
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/activity-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:53 GMT -->
</html>
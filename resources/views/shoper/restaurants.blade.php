@extends('resturant.includes.layout') @section('content')
<div class="row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32">
    <div class="col-auto">
        <h1 class="text-30 lh-14 fw-600">All Restaurants</h1>
    </div>

    <div class="col-auto">
        <a href="{{route('vendor.resturant.create')}}" class="button h-50 px-24 -dark-1 bg-blue-1 text-white">
            Add Restaurants
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row x-gap-10 y-gap-10 items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ route('vendor.resturant.edit', $restaurant->id) }}">
                                                <button class="flex-center bg-light-2 rounded-4 size-35">
                                        ...
                                        <div class="col-auto">
                                            <form action="{{ route('vendor.resturant.destroy', $restaurant->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this category?');">
                                                @csrf @method('DELETE')

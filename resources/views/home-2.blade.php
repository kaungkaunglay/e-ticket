...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:00 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
          ...
          <div class="row y-gap-40">
            ...
            <div class="col-xl-7">
              <div class="masthead__images">
                <div data-anim-child="slide-up delay-6"><img src="img/masthead/2/1.png" alt="image" class="js-mouse-move" data-move="30"></div>
                <div data-anim-child="slide-up delay-7"><img src="img/masthead/2/2.png" alt="image" class="js-mouse-move" data-move="40"></div>
                <div data-anim-child="slide-up delay-8"><img src="img/masthead/2/3.png" alt="image" class="js-mouse-move" data-move="50"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div data-anim-wrap class="container">
        <div class="tabs -pills-2 js-tabs">
          <div data-anim-child="slide-up delay-1" class="row y-gap-20 justify-between items-end">
            <div class="col-auto">
              <div class="sectionTitle -md">
                <h2 class="sectionTitle__title">Best Seller</h2>
            ...
            <div class="col-auto">
              <div class="tabs__controls row x-gap-10 justify-center js-tabs-controls">
                ...
                <div class="col-auto">
                  <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-3">Activity</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-4">Holiday Rentals</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-5">Car</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-6">Cruise</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-7">Flights</button>
                </div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:02 GMT -->
</html>
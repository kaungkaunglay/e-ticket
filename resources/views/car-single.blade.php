...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/car-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:08 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
...
<body>
  ...
  <main>
        ...
        <div class="row y-gap-30">
          <div class="col-lg-8">
            <div class="row y-gap-20 justify-between items-end">
              <div class="col-auto">
                <h1 class="text-30 sm:text-24 fw-600">Mercedes-Benz E-Class or similar</h1>
            ...
            <div class="carsSlider mt-40">
              <div class="carsSlider-slides js-cars-slides">
                ...
                <div class="carsSlider-slides__item rounded-4 -is-active">
                  <img src="img/cars/slider/slides/1.png" alt="image">
                </div>

                <div class="carsSlider-slides__item rounded-4 ">
                  <img src="img/cars/slider/slides/2.png" alt="image">
                </div>

                <div class="carsSlider-slides__item rounded-4 ">
                  <img src="img/cars/slider/slides/3.png" alt="image">
                </div>

                <div class="carsSlider-slides__item rounded-4 ">
                  <img src="img/cars/slider/slides/4.png" alt="image">
                </div>
                ...
                <div class="js-cars-slider">
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <img src="img/cars/slider/1.png" alt="image" class="rounded-4">
                    </div>

                    <div class="swiper-slide">
                      <img src="img/cars/slider/2.png" alt="image" class="rounded-4">
                    </div>

                    <div class="swiper-slide">
                      <img src="img/cars/slider/3.png" alt="image" class="rounded-4">
                    </div>

                    <div class="swiper-slide">
                      <img src="img/cars/slider/4.png" alt="image" class="rounded-4">
                    </div>
                ...
                <div class="row y-gap-15 items-center justify-between">
                  ...
                  <div class="col-auto">
                    <div class="d-flex items-center">
                      ...
                      <div class="size-40 flex-center bg-yellow-1 rounded-4">
                        <div class="text-14 fw-600 text-dark-1">4.8</div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <section class="mt-40">
      <div class="container">
        <h3 class="text-22 fw-500 mb-20">Car Location</h3>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/car-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:11 GMT -->
</html>
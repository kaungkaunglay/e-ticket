...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:10 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
  ...
  <main>
          ...
          <div class="col-auto">
            <div class="d-flex items-center">
              <div class="header__buttons d-flex items-center is-menu-opened-hide">
                <a href="become-expert.html" class="button h-50 px-30 fw-400 text-14 -blue-1 bg-white text-dark-1 sm:d-none">Become An Expert</a>
                <a href="signup.html" class="button h-50 px-30 fw-400 text-14 -outline-white text-white ml-20 sm:ml-0">Sign In / Register</a>
              </div>
    ...
    <section data-anim-wrap class="masthead -type-5">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9">
            <h1 data-anim-child="slide-up delay-4" class="text-60 lg:text-40 md:text-30">Best Travel <span class="text-blue-1 relative">Experience <span class="-line"><img src="img/general/line.png" alt="image"></span></span></h1>

            <p data-anim-child="slide-up delay-5" class="mt-20">Experience the various exciting tour and travel packages and Make hotel reservations, find<br class="lg:d-none"> vacation packages, search cheap hotels and events</p>
        ...
        <div class="relative overflow-hidden pt-40 sm:pt-20 js-section-slider" data-gap="30" data-scrollbar data-slider-cols="xl-5 lg-4 md-3 sm-2 base-1" data-nav-prev="js-tour-prev" data-pagination="js-tour-pag" data-nav-next="js-tour-next">
          <div class="swiper-wrapper">
            ...
            <div data-anim-child="slide-up delay-2" class="swiper-slide">
              ...
              <a href="tour-single.html" class="tourTypeCard -type-1 d-block rounded-4 bg-blue-1-05 rounded-4">
                <div class="tourTypeCard__content text-center pt-60 pb-24 px-30">
                  ...
                  <h4 class="text-dark-1 text-18 fw-500 mt-50 md:mt-30">Wildlife Tour</h4>
            ...
            <div data-anim-child="slide-up delay-3" class="swiper-slide">
              ...
              <a href="tour-single.html" class="tourTypeCard -type-1 d-block rounded-4 bg-blue-1-05 rounded-4">
                <div class="tourTypeCard__content text-center pt-60 pb-24 px-30">
                  <i class="icon-hiking text-60 sm:text-40 text-blue-1"></i>
                  <h4 class="text-dark-1 text-18 fw-500 mt-50 md:mt-30">Adventure Tour</h4>
                  <p class="text-light-1 lh-14 text-14 mt-5">5 Tours From 550$</p>
                </div>
              </a>
            ...
            <div data-anim-child="slide-up delay-4" class="swiper-slide">
              ...
              <a href="tour-single.html" class="tourTypeCard -type-1 d-block rounded-4 bg-blue-1-05 rounded-4">
                <div class="tourTypeCard__content text-center pt-60 pb-24 px-30">
                  <i class="icon-city text-60 sm:text-40 text-blue-1"></i>
                  <h4 class="text-dark-1 text-18 fw-500 mt-50 md:mt-30">City Tours</h4>
                  <p class="text-light-1 lh-14 text-14 mt-5">5 Tours From 550$</p>
                </div>
              </a>
            ...
            <div data-anim-child="slide-up delay-5" class="swiper-slide">
              ...
              <a href="tour-single.html" class="tourTypeCard -type-1 d-block rounded-4 bg-blue-1-05 rounded-4">
                <div class="tourTypeCard__content text-center pt-60 pb-24 px-30">
                  <i class="icon-museum text-60 sm:text-40 text-blue-1"></i>
                  <h4 class="text-dark-1 text-18 fw-500 mt-50 md:mt-30">Museum Tours</h4>
                  <p class="text-light-1 lh-14 text-14 mt-5">5 Tours From 550$</p>
                </div>
              </a>
            ...
            <div data-anim-child="slide-up delay-6" class="swiper-slide">
              ...
              <a href="tour-single.html" class="tourTypeCard -type-1 d-block rounded-4 bg-blue-1-05 rounded-4">
                <div class="tourTypeCard__content text-center pt-60 pb-24 px-30">
                  <i class="icon-beach-umbrella text-60 sm:text-40 text-blue-1"></i>
                  <h4 class="text-dark-1 text-18 fw-500 mt-50 md:mt-30">Beaches Tour</h4>
                  <p class="text-light-1 lh-14 text-14 mt-5">5 Tours From 550$</p>
                </div>
              </a>
    ...
    <section class="layout-pt-md layout-pb-md">
      <div data-anim-wrap class="container">
        ...
        <div class="row y-gap-30 pt-40 sm:pt-20">
          ...
          <div data-anim-child="slide-up delay-2" class="col-xl-3 col-lg-4 col-md-6">
            <a href="#" class="destCard -type-1 d-block">
              <div class="row x-gap-20 y-gap-20 items-center">
                <div class="col-auto">
                  <div class="destCard__image rounded-4">
                    <img class="size-100 rounded-4" src="img/cities/1/1.png" alt="image" class="size-100 rounded-4">
                  </div>
                </div>

                <div class="col-auto">
                  <div class="text-18 fw-500">Miami</div>
                  <div class="text-14 lh-14 text-light-1 mt-5">4,090 properties</div>
                </div>
              </div>
            </a>
          </div>

          <div data-anim-child="slide-up delay-3" class="col-xl-3 col-lg-4 col-md-6">
            <a href="#" class="destCard -type-1 d-block">
              <div class="row x-gap-20 y-gap-20 items-center">
                <div class="col-auto">
                  <div class="destCard__image rounded-4">
                    <img class="size-100 rounded-4" src="img/cities/1/2.png" alt="image" class="size-100 rounded-4">
                  </div>
                </div>

                <div class="col-auto">
                  <div class="text-18 fw-500">Roma</div>
                  <div class="text-14 lh-14 text-light-1 mt-5">4,090 properties</div>
                </div>
              </div>
            </a>
          ...
          <div data-anim-child="slide-up delay-4" class="col-xl-3 col-lg-4 col-md-6">
            <a href="#" class="destCard -type-1 d-block">
              <div class="row x-gap-20 y-gap-20 items-center">
                <div class="col-auto">
                  <div class="destCard__image rounded-4">
                    <img class="size-100 rounded-4" src="img/cities/1/3.png" alt="image" class="size-100 rounded-4">
                  </div>
                </div>

                <div class="col-auto">
                  <div class="text-18 fw-500">New Delhi</div>
                  <div class="text-14 lh-14 text-light-1 mt-5">4,090 properties</div>
                </div>
              </div>
            </a>
          ...
          <div data-anim-child="slide-up delay-5" class="col-xl-3 col-lg-4 col-md-6">
            <a href="#" class="destCard -type-1 d-block">
              <div class="row x-gap-20 y-gap-20 items-center">
                <div class="col-auto">
                  <div class="destCard__image rounded-4">
                    <img class="size-100 rounded-4" src="img/cities/1/4.png" alt="image" class="size-100 rounded-4">
                  </div>
                </div>

                <div class="col-auto">
                  <div class="text-18 fw-500">London</div>
                  <div class="text-14 lh-14 text-light-1 mt-5">4,090 properties</div>
                </div>
              </div>
            </a>
          ...
          <div data-anim-child="slide-up delay-6" class="col-xl-3 col-lg-4 col-md-6">
            <a href="#" class="destCard -type-1 d-block">
              <div class="row x-gap-20 y-gap-20 items-center">
                <div class="col-auto">
                  <div class="destCard__image rounded-4">
                    <img class="size-100 rounded-4" src="img/cities/1/5.png" alt="image" class="size-100 rounded-4">
                  </div>
                </div>

                <div class="col-auto">
                  <div class="text-18 fw-500">Amsterdam</div>
                  <div class="text-14 lh-14 text-light-1 mt-5">4,090 properties</div>
                </div>
              </div>
            </a>
          ...
          <div data-anim-child="slide-up delay-7" class="col-xl-3 col-lg-4 col-md-6">
            <a href="#" class="destCard -type-1 d-block">
              <div class="row x-gap-20 y-gap-20 items-center">
                <div class="col-auto">
                  <div class="destCard__image rounded-4">
                    <img class="size-100 rounded-4" src="img/cities/1/6.png" alt="image" class="size-100 rounded-4">
                  </div>
                </div>

                <div class="col-auto">
                  <div class="text-18 fw-500">Berlin</div>
                  <div class="text-14 lh-14 text-light-1 mt-5">4,090 properties</div>
                </div>
              </div>
            </a>
          ...
          <div data-anim-child="slide-up delay-8" class="col-xl-3 col-lg-4 col-md-6">
            <a href="#" class="destCard -type-1 d-block">
              <div class="row x-gap-20 y-gap-20 items-center">
                <div class="col-auto">
                  <div class="destCard__image rounded-4">
                    <img class="size-100 rounded-4" src="img/cities/1/7.png" alt="image" class="size-100 rounded-4">
                  </div>
                </div>

                <div class="col-auto">
                  <div class="text-18 fw-500">Paris</div>
                  <div class="text-14 lh-14 text-light-1 mt-5">4,090 properties</div>
                </div>
              </div>
            </a>
          ...
          <div data-anim-child="slide-up delay-9" class="col-xl-3 col-lg-4 col-md-6">
            <a href="#" class="destCard -type-1 d-block">
              <div class="row x-gap-20 y-gap-20 items-center">
                <div class="col-auto">
                  <div class="destCard__image rounded-4">
                    <img class="size-100 rounded-4" src="img/cities/1/8.png" alt="image" class="size-100 rounded-4">
                  </div>
                </div>

                <div class="col-auto">
                  <div class="text-18 fw-500">New Zealand</div>
                  <div class="text-14 lh-14 text-light-1 mt-5">4,090 properties</div>
                </div>
              </div>
            </a>
          ...
          <div data-anim-child="slide-up delay-2" class="col-xl-5">
            ...
            <div class="ctaCard -type-1 rounded-4 ">
              <div class="ctaCard__image ratio ratio-63:55">
                <img class="img-ratio js-lazy" src="#" data-src="img/backgrounds/6.png" alt="image">
              </div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:17 GMT -->
</html>
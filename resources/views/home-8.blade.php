...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:24 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
  ...
  <main>
          ...
          <div class="col-auto">
            <div class="d-flex items-center">
              ...
              <div class="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
                <a href="login.html" class="button px-30 fw-400 text-14 -blue-1 bg-dark-1 h-50 text-white">Become An Expert</a>
                <a href="signup.html" class="button px-30 fw-400 text-14 border-dark-1 -blue-1 h-50 text-dark-1 ml-20">Sign In / Register</a>
              </div>
    ...
    <section data-anim-wrap class="masthead -type-8">
      <div data-anim-child="fade" class="masthead__bg">
        <img src="img/masthead/8/bg.png" alt="image" class="col-12 h-full object-cover">
      </div>
        ...
        <div class="row justify-center">
          <div class="col-xl-10">
            <div class="text-center">
              <h1 data-anim-child="slide-up delay-5" class="text-60 lg:text-40 md:text-30 text-dark-1">Search for the Best Car Hire Deals</h1>
              <p data-anim-child="slide-up delay-6" class="text-dark-1 mt-5">Book better cars from local hosts across the US and around the world.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="mainSearch -col-5 -w-1070 mx-auto bg-white pr-20 py-20 lg:px-20 lg:pt-5 lg:pb-20 rounded-4 shadow-1">
          <div class="button-grid items-center">
            ...
            <div class="button-item">
              <button class="mainSearch__submit button -dark-1 py-15 px-35 h-60 col-12 rounded-4 bg-dark-1 text-white">
      ...
      <div data-anim-wrap class="container">
        ...
        <div class="row y-gap-40 justify-between pt-40 sm:pt-20">
          ...
          <div data-anim-child="slide-up delay-2" class="col-lg-4 col-sm-6">
            ...
            <div class="featureIcon -type-1 -hover-shadow px-50 py-50 lg:px-24 lg:py-15">
              <div class="d-flex justify-center">
                <img src="#" data-src="img/featureIcons/2/1.svg" alt="image" class="js-lazy">
              </div>
          ...
          <div data-anim-child="slide-up delay-3" class="col-lg-4 col-sm-6">
            ...
            <div class="featureIcon -type-1 -hover-shadow px-50 py-50 lg:px-24 lg:py-15">
              <div class="d-flex justify-center">
                <img src="#" data-src="img/featureIcons/2/2.svg" alt="image" class="js-lazy">
              </div>
          ...
          <div data-anim-child="slide-up delay-4" class="col-lg-4 col-sm-6">
            ...
            <div class="featureIcon -type-1 -hover-shadow px-50 py-50 lg:px-24 lg:py-15">
              <div class="d-flex justify-center">
                <img src="#" data-src="img/featureIcons/2/3.svg" alt="image" class="js-lazy">
              </div>
                ...
                <div class="carCard__image">
                  ...
                  <div class="cardImage ratio border-light ratio-6:5">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12" src="img/cars/1.png" alt="image">
                    ...
                    <div class="cardImage__content">
                      ...
                      <div class="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider">
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            <img class="col-12" src="img/cars/2.png" alt="image">
                          </div>

                          <div class="swiper-slide">
                            <img class="col-12" src="img/cars/3.png" alt="image">
                          </div>

                          <div class="swiper-slide">
                            <img class="col-12" src="img/cars/1.png" alt="image">
                          </div>
                ...
                <div class="carCard__image">
                  ...
                  <div class="cardImage ratio border-light ratio-6:5">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12" src="img/cars/3.png" alt="image">
                ...
                <div class="carCard__image">
                  ...
                  <div class="cardImage ratio border-light ratio-6:5">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12" src="img/cars/4.png" alt="image">
    ...
    <section class="layout-pt-md layout-pb-lg">
      <div data-anim-wrap class="container">
        ...
        <div class="row y-gap-30 pt-40">
          ...
          <div data-anim-child="slide-up delay-2" class="col-xl-2 col-lg-3 col-sm-6">

            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img class="object-cover js-lazy" src="#" data-src="img/destinations/5/1.png" alt="image">
              </div>
          ...
          <div data-anim-child="slide-up delay-3" class="col-xl-2 col-lg-3 col-sm-6">

            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img class="object-cover js-lazy" src="#" data-src="img/destinations/5/2.png" alt="image">
              </div>
          ...
          <div data-anim-child="slide-up delay-4" class="col-xl-2 col-lg-3 col-sm-6">

            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img class="object-cover js-lazy" src="#" data-src="img/destinations/5/3.png" alt="image">
              </div>
          ...
          <div data-anim-child="slide-up delay-5" class="col-xl-2 col-lg-3 col-sm-6">

            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img class="object-cover js-lazy" src="#" data-src="img/destinations/5/4.png" alt="image">
              </div>
          ...
          <div data-anim-child="slide-up delay-6" class="col-xl-2 col-lg-3 col-sm-6">

            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img class="object-cover js-lazy" src="#" data-src="img/destinations/5/5.png" alt="image">
              </div>
          ...
          <div data-anim-child="slide-up delay-7" class="col-xl-2 col-lg-3 col-sm-6">

            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img class="object-cover js-lazy" src="#" data-src="img/destinations/5/6.png" alt="image">
              </div>
      ...
      <div class="container">
        <div class="row y-gap-30 justify-between items-center">
          <div class="col-xl-5 col-lg-6">
            <h2 class="text-30 fw-600">GoTrip is a World Leading Car Hire Booking Platform</h2>
            <p class="mt-40 lg:mt-20">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
              ...
              <div class="row border-center">
                ...
                <div class="col-sm-6">
                  <div class="py-60 sm:py-30 text-center">
                    <div class="text-40 lg:text-30 lh-13 text-dark-1 fw-600">4,958</div>
                ...
                <div class="col-sm-6">
                  <div class="py-60 sm:py-30 text-center">
                    <div class="text-40 lg:text-30 lh-13 text-dark-1 fw-600">2,869</div>
                    <div class="text-14 lh-14 text-light-1 mt-10">Total Properties</div>
                  </div>
                </div>

                <div class="col-sm-6">
                  <div class="py-60 sm:py-30 text-center">
                    <div class="text-40 lg:text-30 lh-13 text-dark-1 fw-600">2M</div>
                ...
                <div class="col-sm-6">
                  <div class="py-60 sm:py-30 text-center">
                    <div class="text-40 lg:text-30 lh-13 text-dark-1 fw-600">574,974</div>
                    <div class="text-14 lh-14 text-light-1 mt-10">Our Volunteers</div>
                  </div>
                </div>
              ...
              <div data-anim-child="slide-up delay-4" class="col-lg-12 col-md-6">
                <a href="blog-single.html" class="blogCard -type-1 d-flex items-center">
                  <div class="blogCard__image size-130 rounded-8">
                    <img src="img/blog/1.png" alt="image" class="object-cover size-130">
                  </div>

                  <div class="ml-24">
                    <h4 class="text-18 lh-14 fw-500 text-dark-1">The world’s most romantic destinations</h4>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:25 GMT -->
</html>
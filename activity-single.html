...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/activity-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:53 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
      ...
      <div class="container">
        <div class="relative d-flex justify-center js-section-slider" data-gap="10" data-slider-cols="xl-2 lg-2 base-1" data-nav-prev="js-img-prev" data-nav-next="js-img-next" data-loop>
          ...
          <div class="absolute h-full col-12 px-20 py-20 d-flex justify-end items-end">
            <a href="img/lists/activity/single/1.png" class="button -blue-1 px-24 py-15 bg-white text-dark-1 z-2 js-gallery" data-gallery="gallery2">
              See All 90 Photos
            </a>
        ...
        <div class="row y-gap-30">
          <div class="col-lg-8">
            <div class="row justify-between items-end">
              <div class="col-auto">
                <h1 class="text-26 fw-600">Lake District Rail Day Trip from London</h1>
              ...
              <div class="col-12">
                ...
                <div class="show-more -h-60 js-show-more">
                  ...
                  <div class="show-more__button">
                    <button class="d-block text-14 text-blue-1 fw-500 underline mt-10" data-show-more-change-text="Show More, Show Less">
                      Show More
                    </button>
                  </div>
                </div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/activity-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:18:55 GMT -->
</html>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/cruise-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:15 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
    ...
    <section class="pt-40">
      <div class="container">
        <div class="row justify-between items-end">
          <div class="col-auto">
            <h1 class="text-26 fw-600">10 Night Cruise to the Mediterranean</h1>
            ...
            <div class="d-flex x-gap-5 items-center pt-5">
              ...
              <button data-x-click="mapFilter" class="text-15 text-blue-1 underline">Show on map</button>
            </div>
          </div>
        ...
        <div class="row y-gap-30">
          <div class="col-lg-8">
            ...
            <div class="row x-gap-80 y-gap-40 pt-40">
              ...
              <div class="col-12">
                <h5 class="text-16 fw-500">About</h5>
                ...
                <div class="d-flex justify-between items-center">
                  ...
                  <div class="d-flex items-center justify-end">
                    <div class="text-14 lh-14 text-right">
                      <div class="fw-600">Exceptional</div>
                      3,014 reviews
                    </div>
    ...
    <section class="pt-40">
      <div class="container">
        <div class="row y-gap-20">
          <div class="col-auto">
            <h2 class="text-22 fw-500">Cruise Location</h2>
          </div>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/cruise-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jan 2025 09:19:16 GMT -->
</html>